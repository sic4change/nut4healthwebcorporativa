...
frases = {
  "en": {
    ...
    "Acierto": "Acierto",
    "La integración de SAMPhoto, un sistema de diagnóstico por fotografía desarrollado por ACH (con enlace a la web de ACH), permite automatizar el diagnóstico de la desnutrición minimizando el error humano y democratizando su uso.": "La integración de SAMPhoto, un sistema de diagnóstico por fotografía desarrollado por ACH (con enlace a la web de ACH), permite automatizar el diagnóstico de la desnutrición minimizando el error humano y democratizando su uso.",
